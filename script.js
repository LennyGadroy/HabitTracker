const HABITS = [
  { id:'sleep',    name:'Sleep',             emoji:'💤', type:'good', color:'#818cf8', jokerLimit:3 },
  { id:'projets',  name:'Personal Projects', emoji:'🚀', type:'good', color:'#e879f9', jokerLimit:3 },
  { id:'gym',      name:'Gym',               emoji:'🏋️', type:'good', color:'#34d399', jokerLimit:3 },
  { id:'work',     name:'Work',              emoji:'💼', type:'good', color:'#fbbf24', jokerLimit:3 },
  { id:'water',    name:'Water',             emoji:'💧', type:'good', color:'#38bdf8', jokerLimit:2 },
  { id:'read',     name:'Read',              emoji:'📚', type:'good', color:'#a78bfa', jokerLimit:2 },
  { id:'noscroll', name:'No Scroll',         emoji:'📱', type:'bad',  color:'#fb923c', jokerLimit:0 },
  { id:'nofilms',  name:'No Films',          emoji:'🎬', type:'bad',  color:'#f87171', jokerLimit:0 },
];
...
function renderHeatmap() {
  ...
  container.innerHTML = HABITS.map(habit => {
    ...
    const streakLabel = habit.type === 'bad' ? 'd. clean' : 'd. streak';
    return `
